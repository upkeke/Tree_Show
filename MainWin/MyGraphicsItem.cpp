...
MyGraphicsItem::MyGraphicsItem(const QPointF &pos, int val, NodeColor pix_c,
...
int MyGraphicsItem::getVal() { return val; }

void MyGraphicsItem::addLine(MyLineItem *line) { lineArry.push_back(line); }
...
void MyGraphicsItem::clearLines() { lineArry.clear(); }
